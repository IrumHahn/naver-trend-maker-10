...
export type QaCheckStatus = "passed" | "warning" | "failed";
export type QaReportStatus = "pending" | "passed" | "warning" | "failed";
...
export interface SourcingAdminRunSummary {
  ...
  qaStatus?: QaReportStatus;
  qaSummary?: string;
  qaWarningChecks?: number;
  qaFailedChecks?: number;
  createdAt: string;
  updatedAt: string;
}
